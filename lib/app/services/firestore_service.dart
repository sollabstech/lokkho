...
class FirestoreService extends GetxService {
  ...
  List<StudyMaterialModel> _getMockMaterials() {
    return [
      StudyMaterialModel(
        id: 'mat1',
        title: 'Class 10 Maths - Complete Guide',
        subject: 'Mathematics',
        userClass: 'Class 10',
        chapter: 'All Chapters',
        medium: 'English',
        type: 'pdf',
        fileUrl: 'https://example.com/maths10.pdf',
        thumbnailUrl: 'https://via.placeholder.com/300x200/6C63FF/FFFFFF?text=Maths',
        downloads: 1250,
      ),
      StudyMaterialModel(
        id: 'mat2',
        title: 'Science - Cell Biology Notes',
        subject: 'Science',
        userClass: 'Class 9',
        chapter: 'Cell Structure',
        medium: 'English',
        type: 'pdf',
        fileUrl: 'https://example.com/science9.pdf',
        thumbnailUrl: 'https://via.placeholder.com/300x200/00D4FF/FFFFFF?text=Science',
        downloads: 890,
      ),
      StudyMaterialModel(
        id: 'mat3',
      ...
      StudyMaterialModel(
        ...
        medium: 'English',
        type: 'pdf',
        fileUrl: 'https://example.com/english8.pdf',
